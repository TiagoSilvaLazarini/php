...
if(isset($_POST['nome']))
{
	...
	if(!empty($nome) && !empty($data) && !empty($limite) && !empty($preco_curso)){
		...
		$sql_code = "INSERT INTO curso( data_ini, limite, nome_curso, preco_curso) VALUES ('$data', '$limite','$nome','$preco_curso')";
...
?>
	...
	<form action="" method="POST">
		<input type="text" name="nome" placeholder="Nome do curso" maxlength="255">
		<input type="date" name="data" placeholder="Data de inicio" min="2020-01-01"max="3000-12-30">
    	<input type="text" name="preco_curso" placeholder="Preço para o cliente" maxlength="14"onKeyPress="MascaraGenerica(this, 'MOEDA');">
		<input type="text" name="limite" placeholder="Limite de participantes" maxlength="4"onKeyPress="MascaraGenerica(this, 'INTEIRO');">
