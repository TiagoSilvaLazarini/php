...
<body>
  ...
  <script src="../CSS/mask.js"></script>
    ...
    if (!isset($_POST['busca'])) {
        ...
        $sql_code = "SELECT * FROM cliente c INNER JOIN administrador a ON a.id_administrador  = c.id_administrador ORDER BY c.nome_cliente";
    }else{
      $pesquisa = $mysqli->real_escape_string($_POST['busca']);
            ...
            WHERE a.nome_admin LIKE '%$pesquisa%'
