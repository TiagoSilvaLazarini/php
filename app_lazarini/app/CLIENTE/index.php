...
<body>
  ...
  <script src="../CSS/mask.js"></script>
    ...
    if (!isset($_POST['busca'])) {
        $sql_code = "SELECT * FROM cliente c INNER JOIN administrador a ON a.id_administrador = c.id_administrador where c.id_cliente IN (SELECT id_cliente FROM venda) AND c.id_administrador = '$id_admin'
      ...
      $pesquisa = $mysqli->real_escape_string($_POST['busca']);
            $sql_code = "SELECT * FROM cliente c 
                ...
                WHERE c.id_cliente IN (SELECT id_cliente FROM venda) AND (c.nome_cliente LIKE '%$pesquisa%'
    ...
    ?>
        ...
        <div class="adiciona">
            ...
            <?php if($_SESSION['tipo'] == "S") {?> <a href="pesquisa_admin.php" class="btn btn-primary">Admin</a><?php }?>
            <a href="pesquisa_prod.php" class="btn btn-primary">Produto</a>
            <a href="pesquisa_entrega.php" class="btn btn-primary">Entrega tecnica</a>
            <a href="pesquisa_boleto.php" class="btn btn-primary">Boleto</a>
            <a href="pesquisa_venda.php" class="btn btn-primary">Vendas</a>
            <a href="sem_venda.php" class="btn btn-primary">Cliente sem venda</a>
